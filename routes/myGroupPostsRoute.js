...
myGroupPostsRouter.get("/:groupID", authenticateToken, async (req, res) => {
...
// Add a new post
myGroupPostsRouter.post("/:groupID/add-post", authenticateToken, async (req, res) => {
  const { groupID } = req.params;
...
// Delete a post
myGroupPostsRouter.delete("/:groupID/delete-post", authenticateToken, async (req, res) => {
  const { groupID } = req.params;
...
// Edit a post
myGroupPostsRouter.put("/:groupID/edit-post", authenticateToken, async (req, res) => {
  const { groupID } = req.params;
