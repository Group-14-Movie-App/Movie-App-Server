...
// Get group details
otherGroupDetailsRouter.get("/:groupID", async (req, res) => {
...
otherGroupDetailsRouter.get("/:groupID/status", async (req, res) => {
    const { groupID } = req.params;
...
// Cancel a pending join request
otherGroupDetailsRouter.delete("/:groupID/cancel-request", async (req, res) => {
    const { groupID } = req.params;
