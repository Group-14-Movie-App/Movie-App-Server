...
mygroupDetailsRouter.get("/:groupID", async (req, res) => {
...
mygroupDetailsRouter.get("/:groupID/join-requests", async (req, res) => {
    const { groupID } = req.params;
...
mygroupDetailsRouter.post("/:groupID/accept-request", async (req, res) => {
    const { groupID } = req.params;
    const { userID } = req.body;
  
    try {
      // Delete the pending join request from GroupJoinRequests
      ...
      // Add the user to GroupMembers with isPending = FALSE
...
mygroupDetailsRouter.post("/:groupID/decline-request", async (req, res) => {
    const { groupID } = req.params;
    const { userID } = req.body;
...
// Get group members
mygroupDetailsRouter.get("/:groupID/members", async (req, res) => {
    const { groupID } = req.params;
...
mygroupDetailsRouter.delete("/:groupID/remove-member", async (req, res) => {
    const { groupID } = req.params;
    const { userID } = req.body;
    ...
    try {
      ...
      // Remove any pending join requests for this group and user
